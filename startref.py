...
def check_files():
    """
    Ensures `proxies.txt` exist. Prompts the user to create them if missing.
    """
    check_or_create_file(
        'proxies.txt',
        "You need a proxies.txt file containing your proxy list (one per line) with protocol://user:pass@ip:port format."
    )
...
def print_banner():
    ...
    {Fore.CYAN}
      ...
      /  \/ / _ \ / _` |/ _ \ '_ \ / _ \| __|                
     / /\  / (_) | (_| |  __/ |_) | (_) | |_                 
     \_\ \/ \___/ \__,_|\___|_.__/ \___/ \__|                
                                                             
       _              __        _ _          _      _        
      | |__  _   _    \ \ _   _| (_)_      _(_) ___| | _____ 
      | '_ \| | | |    \ \ | | | | \ \ /\ / / |/ __| |/ / __|
      | |_) | |_| | /\_/ / |_| | | |\ V  V /| | (__|   <\__ \
    ...
    print(f"{Fore.YELLOW}       Nodepay Referral")
